                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br />
                                <g:form controller="crearMateria" method="POST" class="form-horizontal form-label-left input_mask">

                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <!--<input type="text" class="form-control has-feedback-left" id="nombre" placeholder="Nombre">-->
                                        <g:textField class="form-control has-feedback-left" placeholder="Materia" id="materia" name="nombreMateria"></g:textField>
