...
<html>
<head>
    <title>Asignar Estudiante a Profesor</title>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br />
                                <g:form controller="asignarEstudianteGrupo" action="asignarEstudianteGrupo" method="POST" class="form-horizontal form-label-left input_mask">
                                    ...
                                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                                            <thead>
                                            <tr>
                                                <th><input id="checkAll" type="checkbox" /> Selected</th>
                                                <th>Nombre</th>
                                                <th>Apellido</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <g:each in="${estudiantes}" var="est">
                                                <tr id="${est.id}">
                                                    <td><input class="checkSelected" type="checkbox"></td>
                                                    <td>${est.nombre}</td>
                                                    <td>${est.apellido}</td>
                                    ...
                                    <div class="form-group" style="float:right">
                                        <div>
                                            ...
                                            <%--<g:actionSubmit id="guardar" value="Guardar"  class="btn btn-success"></g:actionSubmit>--%>
...
<script>
    ...
    $("#materias").change(function () {
        ...
        jQuery.ajax({
            url: "${createLink(controller: 'asignarEstudianteGrupo', action: 'obtenerGrupos')}",
            type: "GET",
    ...
    $("#guardar").click(function () {
        ...
        $(".checkSelected").each(function () {
            if($(this).prop('checked') == true){
                alert("El id " + $(this).parent().parent().prop("id"));
                estuList.push($(this).parent().parent().prop("id"));

            }

        });

        alert("Esta es la lista " + estuList);

        var param = new Object();
        param.estudiantesList = new Array();
        param.estudiantesList = estuList;

        jQuery.ajax({
            url: "${createLink(controller: 'asignarEstudianteGrupo', action: 'guardarEstudiantes')}",
            type: "POST",
            traditional: true,
            data: {elist:estuList,grupoId:grupoId},
            success: function (data) {
